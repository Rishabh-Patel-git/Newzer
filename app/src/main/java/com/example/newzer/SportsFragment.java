...
public class SportsFragment extends Fragment {
    ...
    private final String SPORTS_URL = " https://newsapi.org/v2/top-headlines?country=in&category=sport&apiKey=98d961fbf71e4da4a4d72cc957d9cea0";
    private String s = "";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        VolleyUtility.fetchData(getContext(), SPORTS_URL, new VolleyUtility.VolleyOnEventListener() {
            @Override
